...
export const VERTICAL_THEMES: Record<VerticalKey, VerticalTheme> = {
  ...
  'emergency-trades': {
    ...
    ctaGradient: 'linear-gradient(135deg, #FF6B35 0%, #FF9A5C 100%)',
  ...
  'legal-financial': {
    ...
    ctaGradient: 'linear-gradient(135deg, #C9A84C 0%, #E0C070 100%)',
  ...
  'events-creative': {
    ...
    ctaGradient: 'linear-gradient(135deg, #C9A07A 0%, #E8C4A0 100%)',
  ...
  'fitness-wellness': {
    ...
    ctaGradient: 'linear-gradient(135deg, #2ECC71 0%, #58D68D 100%)',
  ...
  'beauty-grooming': {
    ...
    ctaGradient: 'linear-gradient(135deg, #C4748A 0%, #E8A8B8 100%)',

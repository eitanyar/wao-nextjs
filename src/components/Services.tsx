...
const DEFAULT_ITEMS = [
  { icon: "🤖", title: "בניית אתר (Site Bot)", desc: "בוט שבונה לך אתר עסקי מקומי ומחבר אותו לפרופיל העסק שלך בגוגל — כדי שלקוחות באזור ימצאו אותך כשהם מחפשים. הכל מתוך שיחה בצ׳אט, בלי מעצב ובלי טפסים. מתחילים ב-₪9.90.", href: "/site-bot" },

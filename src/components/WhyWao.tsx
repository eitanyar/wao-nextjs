...
const DEFAULT_REASONS = [
  ...
  { icon: "🤖", title: "עובדים על נתונים אמיתיים", desc: "לא מנחשים מסריקה חיצונית. מתחברים ל-Search Console שלכם ורואים באילו מילים גוגל כבר מציג אתכם — ומשם בונים את העבודה." },

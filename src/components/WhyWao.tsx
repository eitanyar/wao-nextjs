...
const DEFAULT_REASONS = [
  { icon: "🏆", title: "20+ שנות ניסיון מוכח", desc: "מאז 2006 אנחנו מלווים עסקים ישראלים לצמיחה דיגיטלית. הניסיון שלנו שווה לך זמן וכסף." },
  { icon: "🤝", title: "ללא חוזה ארוך טווח", desc: "אנחנו מאמינים בתוצאות, לא בחוזים שמחזיקים לקוחות. כל חודש אתה נשאר — כי זה עובד." },
  { icon: "🤖", title: "עובדים על נתונים אמיתיים", desc: "בלי ניחושים ובלי סריקות גנריות: מתחברים ישירות ל-Search Console שלך, רואים באילו מילים גוגל כבר מציג אותך — ומשם בונים את העבודה." },
  { icon: "📊", title: "שקיפות מלאה בנתונים", desc: "גישה מלאה לכל הנתונים, דוחות ברורים ושיחות עדכון שבועיות — אתה תמיד יודע מה קורה." },
  { icon: "🎯", title: "התמחות עמוקה בישראל", desc: "הבנה מלאה של השוק הישראלי, התנהגות החיפוש העברי והתחרות המקומית — יתרון שאין לרשתות בינלאומיות." },
  { icon: "⚡", title: "משנים כיוון מהר", desc: "הדיגיטל משתנה מהר. אנחנו מגיבים מהר — מתאימים אסטרטגיות לשינויי גוגל, שוק ותחרות." },
];
...
export default function WhyWao({ data }: Props) {
  ...
  const subtitle = data?.subtitle ?? "ההבדל בין סוכנות שיווק רגילה לבין וואו הוא פשוט: אנחנו מודדים את עצמנו לפי התוצאות שלך, לא לפי שעות עבודה.";

        ...
        <div className="wao-container" style={{ maxWidth: "760px" }}>
          ...
          <div style={{ display: "flex", gap: "24px", alignItems: "flex-start", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: "220px" }}>
              <div itemProp="name" style={{ fontFamily: "var(--font-rubik), sans-serif", fontWeight: 800, fontSize: "1.15rem", marginBottom: "4px" }}>איתן יריב</div>
              <div itemProp="jobTitle" style={{ color: "var(--muted)", fontSize: "0.85rem", fontFamily: "var(--font-body), sans-serif", marginBottom: "12px" }}>מומחה Google Ads ו-GTM | מייסד WAO | 20+ שנות ניסיון</div>

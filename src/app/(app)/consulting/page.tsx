...
export const metadata: Metadata = {
  title: "יועץ שיווק דיגיטלי — WAO עושים ולא רק מספרים, מאז 2006",
  description:
...
const STEPS = [
  {
    ...
    desc: "מעבירים לך שאלונים ממוקדים שעוזרים לנו (ולך) לחדד שני דברים: מי הלקוח האידיאלי שלך באמת, ומה הבידול והיתרון היחסי שלך בשוק. רק אחרי שיש לנו תמונה מלאה — יושבים יחד לתכנן.",
    tags: ["שאלוני גילוי", "לקוח אידיאלי", "בידול", "יתרון יחסי"],
  },
  {
    n: "02",
    title: "שיחת אסטרטגיה — עד 30 דקות, ללא עלות",
    desc: "לאחר שמילאת את שאלוני הגילוי, אנחנו בוחנים את הנכסים הדיגיטליים שלך — אתר, דפי נחיתה ופרופילי הרשתות החברתיות. משם קובעים שיחה ממוקדת של עד 30 דקות להצגת כיוון אסטרטגי רלוונטי לעסק שלך.",
    tags: ["אבחון דיגיטלי", "נכסים דיגיטליים", "30 דקות", "כיוון אסטרטגי"],
  },
  {
    n: "03",
    title: "ביצוע — אנחנו עושים, לא רק ממליצים",
    desc: "אם החלטת להתקדם איתנו — בונים את המשפך השיווקי ועולים לאוויר. SEO, Google Ads, תוכן, מדיה חברתית — בשילוב שמתאים לעסק שלך ולתקציב שהגדרת. בעידן ה-AI של 2026 חלק ניכר מהביצוע רץ דרך בוטי WAO — Site Bot, Ads Bot, Content Bot ו-GEO Bot — כך שהתוצאות מגיעות מהר יותר ובעלות תפעולית נמוכה יותר.",
    tags: ["ביצוע", "Google Ads", "SEO", "שיווק תוכן", "AI כלים"],
  },
  {
    n: "04",
    title: "מדידה ושיפור — ותשלום רק בסוף החודש",
    desc: "כל חודש בוחנים את התוצאות יחד. מה עבד, מה לשפר, ולאן ממשיכים. גובים תשלום רק בסוף החודש — ואז אתה מחליט אם להמשיך. אין אצלנו אותיות קטנות, עלויות נסתרות או חוזים שכובלים אותך.",
    tags: ["מדידה", "ROI", "דיווח שקוף", "חודש-חודש"],
  },
];

const INCLUDED = [
  { icon: "🎯", title: "אסטרטגיית שיווק מותאמת אישית", desc: "לא תבנית מוכנה. תכנית עבודה שנבנית לפי העסק, הלקוחות והתקציב שלך." },
  ...
  { icon: "⚙️", title: "בניית משפך שיווקי ותוכן", desc: "מהחשיפה הראשונה ועד הרכישה — בונים מסע לקוח שמניע להמרות, כולל תוכן שמותאם לעידן ה-AI." },
  { icon: "📊", title: "KPI Dashboard ודיווח שקוף", desc: "גישה מלאה לנתונים. דוח חודשי ברור. אתה תמיד יודע מה קורה עם הכסף שלך." },
  { icon: "🤝", title: "מנהל שיווק צמוד — חודש בחודשו", desc: "כמו מנהל שיווק פנימי, רק במיקור חוץ: שיחת עדכון שבועית, מענה מהיר לשאלות, והתאמת האסטרטגיה כשהשוק משתנה. בלי חוזה. בלי הפתעות." },
];

const FAQS = [
  {
    q: "למה WAO שונים מיועצי שיווק אחרים?",
    a: "רוב היועצים מספקים מצגת ואסטרטגיה — ואז אתה לבד עם הביצוע. אנחנו לא רק יועצים, אלא מנהלי השיווק שלך במיקור חוץ: מגדירים את האסטרטגיה ביחד, מוציאים אותה לפועל, ולוקחים אחריות לתוצאות מדידות — לא רק למסמכים יפים. חוזה ארוך שאינו מחויב לתוצאות גורם לשיווק לעבור לטייס אוטומטי.",
  },
  {
    q: "האם הייעוץ של WAO מתאים לי?",
  ...
  },
  {
    ...
    a: "שלושה שלבים פשוטים, ללא עלות: ממלאים שאלון קצר על ה-USP והבידול שלך — אנחנו בוחנים את הנכסים הדיגיטליים שלך (אתר, דפי נחיתה, פרופילי רשת) — וקובעים שיחה של עד 30 דקות לדיון בכיוון אסטרטגי רלוונטי. ללא התחייבות.",
  },
  {
    q: "כמה עולה הייעוץ וניהול השיווק?",
    a: "מחיר הניהול תלוי בהיקף הפעילות: מתחיל מ-3,500 ₪ לחודש (בתוספת תקציב מדיה). אנחנו גובים מעל ממוצע השוק — כי לתוצאות חזקות, אחריות ו-20+ שנות ניסיון יש מחיר מתאים. ואנחנו שקופים לגמרי לגבי מה אתה מקבל בכל שקל.",
  },
  {
      ...
      <section style={{ paddingTop: "clamp(110px,14vw,160px)", paddingBottom: "clamp(64px,8vw,96px)", position: "relative", overflow: "hidden" }}>
        ...
        <div className="wao-container" style={{ position: "relative", zIndex: 1, maxWidth: "860px" }}>
          ...
          <p style={{ ...bodyStyle, fontSize: "clamp(1rem,1.8vw,1.2rem)", marginBottom: "40px", maxWidth: "620px" }}>
            רוב היועצים מגיעים עם מצגת ונעלמים. אנחנו מגיעים עם אסטרטגיה, מוציאים אותה לפועל, ומודדים תוצאות בכל שלב. ללא חוזה, תשלום רק בסוף החודש. והביצוע בפועל? עובר היום דרך חבילת בוטי ה-AI של WAO — אתה מקבל ראש אסטרטגי אנושי, וביצוע שרץ מהר יותר משום סוכנות רגילה.
          </p>
          ...
          <div className="cta-banner" style={{ padding: "clamp(48px,8vw,80px) clamp(24px,6vw,64px)", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p style={{ color: "var(--muted)", fontFamily: "var(--font-body), sans-serif", marginBottom: "32px", maxWidth: "480px", margin: "0 auto 32px", lineHeight: 1.75 }}>
                מלאו שאלון קצר על ה-USP והבידול שלכם, אנחנו בוחנים את הנכסים הדיגיטליים — וקובעים שיחה של עד 30 דקות.
              </p>

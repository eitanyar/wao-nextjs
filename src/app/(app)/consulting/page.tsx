...
const FAQS = [
  {
    ...
    a: "רוב היועצים מספקים מצגת ואסטרטגיה — ואז אתה לבד עם הביצוע. אנחנו אנשי ביצוע: מגדירים את האסטרטגיה ביחד ואז מוציאים אותה לפועל. לוקחים אחריות לתוצאות מדידות, לא רק למסמכים יפים. חוזה ארוך שלא מחויב לתוצאות גורם לשיווק לעבור לטייס אוטומטי.",
  },
  {

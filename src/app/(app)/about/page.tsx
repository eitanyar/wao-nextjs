...
const TEAM = [
  {
    ...
    initials: "א.י",
    bio: "20+ שנות ניסיון בשיווק דיגיטלי. התחיל כשכיר בחברת קידום האתרים הראשונות בישראל — ניהל פרויקטים עבור דפי זהב, בנק לאומי, למטייל ואולסייל. מאז 2006 מוביל את WAO כסוכנות בוטיק B2C. מתמחה ב-SEO, Google Ads ואסטרטגיה שיווקית.",

          ...
          <div className="author-bio" itemScope itemType="https://schema.org/Person">
            ...
            <div className="author-meta">
              ...
              <p className="author-text" itemProp="description">
                עוסק ב-SEO מאז ימי ה-PageRank הידני. לאורך השנים ניהלתי פרויקטי קידום עבור דפי זהב (כיום
                זאפ), בנק לאומי, למטייל ואולסייל, ומאז 2006 אני מוביל לקוחות B2C ישראלים
                בצמיחה אורגנית מתמשכת. ראיתי כל שינוי אלגוריתם מהבסיס — ואני משתמש בניסיון
                הזה כדי לוודא שהלקוחות שלי תמיד צעד אחד לפני כולם.
              </p>

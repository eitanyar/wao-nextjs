          ...
          <article itemScope itemType="https://schema.org/Article">
            ...
            <section id="what-is-keyword-research">
              ...
              <p style={BODY}>
                ...
                הצעד הראשון – והכי קריטי – בכל תוכנית עבודה של קידום אתרים. זהו המצפן
                שמגלה לכם מה בדיוק הלקוחות שלכם מקלידים בגוגל, כדי שלא תבזבזו זמן יקר
                על כתיבת תוכן שאף אחד לא צריך.
              </p>
              <p style={BODY}>
                המשוואה פשוטה: מחקר רע שווה לתוכן שאף אחד לא קורא. מחקר מדויק מביא
                איתו תנועה אורגנית של אנשים שבאמת רוצים לקנות. והפער בין השניים קם
                ונופל על דבר אחד:{" "}
                <strong style={{ color: "var(--text)" }}>כוונת חיפוש (<GT term="Search Intent">Search Intent</GT>)</strong>.
              </p>
              <div style={CALLOUT}>
                <strong>📌 מחקר מילות מפתח ב-2026 שונה:</strong> גוגל כבר מזמן לא רובוט
                טיפש שרק סופר מילים – היא מבינה נושאים והקשרים. לכן, מחקר מודרני לא
                מחפש "מילת קסם" בודדת, אלא{" "}
                <strong>בונה רשת תוכן שלמה (Keyword Cluster)</strong> שמוכיחה שאתם
                האוטוריטה הבלעדית בתחום.
              </div>
            ...
            <section id="search-intent">
              ...
              <p style={BODY}>
                <strong style={{ color: "var(--text)" }}><GT term="Search Intent">כוונת החיפוש</GT></strong> היא
                המפתח האמיתי להצלחה. גוגל מחלקת את השאילתות של הגולשים לארבעה סוגים מרכזיים:
              </p>
            ...
            <section id="long-tail">
              ...
              <p style={BODY}>
                ביטויי <GT term="Long-Tail">זנב ארוך (Long-Tail)</GT> הם ארוכים
                וספציפיים. הם אמנם מביאים פחות נפח, אבל הגולשים שמגיעים דרכם בשלים
                בהרבה לרכישה. במקום להקיז דם על ביטוי תחרותי כמו "קידום אתרים" מול אלפי
                אתרים חזקים, הרבה יותר חכם לשלוט בביטוי כמו "קידום אתרים למסעדות בתל אביב".
              </p>
            ...
            <section id="competitive-gap">
              ...
              <p style={BODY}>
                לרגל אחרי המתחרים זה לא רק לשלוף את רשימת המילים שלהם – זה לפענח מה
                בדיוק גורם להם להצליח, ואיך אתם יכולים לבנות אסטרטגיה שתעקוף אותם בסיבוב.
              </p>
            ...
            <section id="keyword-clustering">
              ...
              <p style={BODY}>
                אחרי שאספתם ערימה מטורפת של מילים, הגיע הזמן לעשות בהן סדר. השלב הבא
                הוא <strong style={{ color: "var(--text)" }}>קיבוץ (Clustering)</strong>{" "}
                של הביטויים לקבוצות נושאים ברורות, שכל אחת מהן תהפוך לעמוד תוכן ייעודי
                ועמוק באתר שלכם.
              </p>
              <div style={CALLOUT}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "1.6rem" }}>
                {[
                  ...
                  { step: "שלב 3: סיווג לפי כוונה", desc: "לכל Cluster — קבעו את כוונת החיפוש הדומיננטית. אינפורמטיבית → מאמר. עסקית → דף שירות. השוואתית → Roundup." },

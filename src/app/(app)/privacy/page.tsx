      ...
      <div className="wao-container" style={{ maxWidth: "760px" }}>
        ...
        <div style={SECTION}>
          ...
          <ul style={{ paddingRight: "20px", margin: "0 0 16px" }}>
            ...
            <li style={LI}>
              <strong style={{ color: "var(--text)" }}>בדיקת פרופיל עסקי בגוגל</strong> — שם העסק
              ששלחת בטופס הבדיקה. הבדיקה מתבססת על מידע מ-Google Places. המידע משמש
              להכנת דוח הבדיקה שביקשת בלבד. הוא לא משמש לפניות שלא קשורות לבדיקה.
            </li>
          </ul>
          <p style={P}>
        ...
        <div style={SECTION}>
          ...
          <ul style={{ paddingRight: "20px", margin: "0 0 10px" }}>
            ...
            <li style={LI}>
              נתוני בדיקת הפרופיל העסקי — נשמרים 30 ימים ונמחקים אוטומטית לאחר מכן.
              לבקשת מחיקה מוקדמת פונים דרך{" "}
              <a href="/contact#contact-form" style={{ color: "var(--accent)" }}>טופס יצירת הקשר</a>.
            </li>
          </ul>
        </div>

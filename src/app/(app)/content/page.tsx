...
export const metadata: Metadata = {
  title: "שיווק תוכן מקצועי — תוכן שמביא לקוחות",
  description:
...
const STEPS = [
  {
    ...
    desc: "לפני שנוגעים במקלדת, אנחנו מפענחים את הלקוח שלכם. אילו התלבטויות מריצות אותו לגוגל? מה כואב לו? מה המתחרים שלכם מפספסים בתשובות שלהם? התשובות לשאלות האלה קובעות את כל תוכנית התוכן.",
    tags: ["מחקר קהל יעד", "ניתוח מתחרים", "מיפוי שאלות"],
  },
  {
    n: "02",
    title: "מבנה — לבנות סמכות, לא רק לכתוב מאמרים",
    desc: "מאמרים מפוזרים לא בונים סמכות. אנחנו מייצרים מבנה היררכי ברור: נושא עוגן מרכזי המוקף ברשת מאמרים שמכסה כל תת-שאלה אפשרית. כשגוגל רואה אתר שעונה לעומק על נושא שלם — הוא מתחיל לדרג אותו גבוה על כל שאלה קשורה.",
  ...
  },
  {
    ...
    desc: "כשהתוכן מוכן, אנחנו אורזים אותו לפי הספר עבור מנועי החיפוש. זה כולל אופטימיזציית כותרות, הנדסת קוד, קישורים פנימיים ומהירות טעינה. בנוסף — מבנה תוכן ייעודי שמגדיל את הסיכוי שגוגל יציג את התוכן שלכם בסיכומי ה-AI.",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "WAO כותב את הכל. הכל מתחיל בראיון קצר וממוקד שבו אנחנו שואבים מכם את הידע המקצועי – ואז הופכים אותו לטקסט ברמת גימור עילאית. אם יש לכם כותב פנים-ארגוני, אפשר לחלק: לנו האסטרטגיה, המחקר והעריכה — לכם חלק מהכתיבה.",
  },
  {
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "32px", marginTop: "40px" }}>
            {[
              ...
              },
              {
                ...
                body: "ב-2026, גוגל מציג תשובות מסיכום AI לפני כל קישור. רק עסקים עם תוכן מוסמך, מעמיק ומובנה נכון מופיעים שם. זה לא עניין טכני יבש – זה ציון האמינות הרשמי שגוגל מעניק למותג שלכם.",
              },
            ].map((item) => (
        ...
        <div className="wao-container" style={{ maxWidth: "860px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(32px,5vw,64px)", alignItems: "center" }}>
            <div>
              ...
              <p style={{ ...bodyStyle }}>
                אנחנו ב-WAO אלרגים לתוכן גנרי משועתק. כל פיסת תוכן נולדת מתוך שיחה אנושית עם המומחים שלכם, כולל דוגמאות מהשטח ונקודות מבט שאף אחד אחר לא יכול לתת.
              </p>
            </div>
        ...
        <div className="wao-container">
          <div style={{ marginBottom: "60px" }}>
            ...
            <p style={{ ...bodyStyle, marginTop: "12px", maxWidth: "580px" }}>
              שיווק תוכן אפקטיבי הוא לא מירוץ כתיבה כמותי – אלא דיוק של מסר, קהל ועיתוי. כל שלב, מהתכנון ועד לאנליטיקס, נועד לוודא שהמאמר שלכם מייצר עבודה.
            </p>
          </div>

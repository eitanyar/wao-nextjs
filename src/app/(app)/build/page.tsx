      ...
      <section style={{ paddingTop: "clamp(110px,14vw,160px)", paddingBottom: "clamp(64px,8vw,96px)", position: "relative", overflow: "hidden" }}>
        ...
        <div className="wao-container" style={{ position: "relative", zIndex: 1, maxWidth: "880px" }}>
          ...
          <p style={{ ...bodyStyle, fontSize: "clamp(1rem,1.8vw,1.2rem)", marginBottom: "20px", maxWidth: "660px" }}>
            כל שנייה נוספת של זמן טעינה עולה 7% בהמרות. אתר WordPress ממוצע בישראל טוען ב-4-7 שניות. אתר <GT term="Next.js">Next.js</GT> שאנחנו בונים — מתחת לשנייה.
          </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px", marginTop: "36px" }}>
            {[
              ...
              },
              {
                ...
                body: "WordPress דורש עדכוני אבטחה שבועיים, גיבויים, תאימות פלאגינים. לקוחות רבים מגיעים אלינו אחרי שהאתר שלהם נפרץ או נשבר מעדכון. עם Next.js — אין פלאגינים, אין סיוטים.",
              },
              {
                icon: "📉",
                ...
                body: (
                  <>
                    WordPress יוצר קוד כבד, <GT term="Indexing">אינדוקס</GT> עמודים לא רלוונטיים, ו-Structured Data שבור ברוב הפלאגינים. Next.js מתחיל בנקודת זינוק גבוהה יותר — עוד לפני שכתבנו מילה אחת של תוכן.
                  </>
                ),
              },
            ].map((item) => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(32px,5vw,64px)", alignItems: "center" }}>
            <div>
              ...
              <p style={{ ...bodyStyle, marginBottom: "20px" }}>
                מפתחי Web רגילים בונים אתרים יפים. מומחי SEO יודעים מה גוגל רוצה. NAO עושה גם וגם — וזה ההבדל שמשנה.
              </p>
              <p style={{ ...bodyStyle, marginBottom: "20px" }}>
                אנחנו עובדים עם כלי AI מתקדמים שמאפשרים פיתוח מהיר בלי לוותר על האיכות. פרויקט שלקח 3 חודשים בעבר — היום 4-6 שבועות. הזמן שנחסך הולך לדבר שאין לו קיצורי דרך: מחקר SEO, מבנה Topical Authority, ו-<GT term="E-E-A-T">E-E-A-T</GT> signaling שגוגל מחפש.
              </p>
              <p style={{ ...bodyStyle }}>

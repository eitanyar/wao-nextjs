...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  "AI Overviews": {
    ...
    body: "בלוק שגוגל מציג בראש תוצאות החיפוש עם תשובת AI לפני התוצאות האורגניות. נכון ל-2026, הוא מופיע בכ-63% מהחיפושים, ואתרים שמצוטטים בו מרוויחים חשיפה אדירה למותג גם ללא קליק ישיר.",
  },
  "E-E-A-T": {
    knowledgeSlug: "eeat",
    category: "seo",
    short: "ניסיון · מומחיות · סמכות · אמינות",
    body: "ארבעת הפרמטרים (ניסיון, מומחיות, סמכות ואמינות) שהאלגוריתם של גוגל משתמש בהם כדי להעריך איכות תוכן. ה-E השנייה (ניסיון מעשי) נוספה ב-2022 והיא קריטית בעיקר בנושאי כסף ובריאות.",
  },
  "Topical Authority": {
    knowledgeSlug: "topical-authority",
    category: "seo",
    short: "סמכות נושאית — בעיני גוגל",
    body: "ציון האמון שגוגל מעניק לאתר בתחום ספציפי. אתר שמכסה נושא שלם לעומק ומכל זווית אפשרית ידורג גבוה יותר מאתר שמציע רק מאמר בודד, טוב ככל שיהיה. נבנית על פני חודשים ושנים.",
  },
  "Core Web Vitals": {
  ...
  "LCP": {
    ...
    body: "הזמן שלוקח לרכיב הכי גדול בדף (תמונה או בלוק טקסט) להיטען לחלוטין. ציון טוב: מתחת ל-2.5 שניות. מעל 4 שניות? קיבלתם ציון אדום ופגיעה ישירה בדירוגים.",
  },
  "CLS": {
    knowledgeSlug: "cls",
    category: "seo",
    short: "Cumulative Layout Shift — יציבות ויזואלית",
    body: "מדד הבוחן כמה הדף 'קופץ' ומשנה פריסה בזמן הטעינה. ציון טוב: מתחת ל-0.1. האשמים הטיפוסיים: תמונות ללא מידות מוגדרות או פרסומות שמזיזות את הטקסט.",
  },
  "INP": {
    knowledgeSlug: "inp",
    category: "seo",
    short: "Interaction to Next Paint — תגובתיות הדף",
    body: "מודד כמה זמן לוקח לדף להגיב לפעולת גולש (קליק או הקשה). המדד החליף רשמית את מדד FID הוותיק ב-2024.",
  },
  "FID": {
    category: "seo",
  ...
  "Crawling": {
    ...
    body: "השלב שבו הבוט של גוגל מבקר באתר, קורא את התוכן ומגלה קישורים פנימיים. הנוסחה פשוטה: בלי סריקה אין אינדוקס, ובלי אינדוקס – אתם פשוט לא קיימים בגוגל.",
  },
  "Indexing": {
    knowledgeSlug: "crawling-indexing",
    category: "seo",
    short: "אינדוקס — גוגל מוסיף את הדף למאגר שלו",
    body: "הרגע שבו גוגל מאשר את הדף ומכניס אותו למאגר הרשמי שממנו נשלפות תוצאות החיפוש. דף שלא אונדקס כראוי לא יופיע בגוגל לעולם.",
  },
  "Noindex": {
    knowledgeSlug: "indexing-bloat",
    category: "seo",
    short: "Noindex — הנחיה לגוגל לא לאנדקס דף",
    body: "הנחיה בקוד שאומרת לגוגל: ”מותר לך לסרוק את העמוד, אבל אל תציג אותו בתוצאות”. מושלם לדפי תודה, תנאי שימוש או תוכן פנימי רגיש.",
  },
  "Robots.txt": {
  ...
  "Meta Description": {
    ...
    body: "תקציר בן 150–160 תווים שמופיע מתחת לכותרת בגוגל. הוא לא משפיע ישירות על המיקום שלכם, אבל קופי שיווקי חד כאן פשוט יגרום ליותר אנשים להקליק ולפרק את המתחרים.",
  },
  "Title Tag": {
  ...
  "Backlinks": {
    ...
    body: "הקישורים שאתרים אחרים ברשת מפנים אליכם. זהו אחד הסיגנלים הכי חזקים באלגוריתם של גוגל: 10 קישורים מאתרים סמכותיים ורלוונטיים שווים הרבה יותר מ-1,000 קישורים מאתרי זבל.",
  },
  "Domain Authority": {
  ...
  "Anchor Text": {
    ...
    body: "המילים הפיזיות שעליהן לוחצים כדי לעבור קישור. גוגל נעזר בהן כדי להבין מה מחכה לגולש בצד השני. ביטוי מוגדר כמו 'מדריך קידום אתרים' תמיד עדיף על 'לחץ כאן' סתמי, אבל חזרתיות יתר עלולה להיתפס כספאם.",
  },
  "Internal Linking": {
  ...
  "PBNs": {
    ...
    body: "רשת אתרי קש פיקטיביים שכל מטרתה היא להוציא קישורים מלאכותיים כדי ”לעבוד” על גוגל. מדובר בהפרה בוטה של ההנחיות: גוגל כבר מזמן יודע לזהות את זה, ועונש רשמי עלול למחוק לכם את האתר מהאינדקס בשניות.",
  },
  "Content Cluster": {
  ...
  "Featured Snippet": {
    ...
    body: "תיבת תשובה מהירה שגוגל מציג בטופ של עמוד התוצאות (מיקום אפס), השלופה מתוך אתר מוביל. זהו מגנט קליקים מטורף, וכדי להגיע לשם צריך לעצב את התוכן במבנה מדויק של שאלות ותשובות.",
  },
  "Local Pack": {
  ...
  "Quality Score": {
    ...
    body: "מדד של גוגל (בין 1 ל-10) המשקלל את רלוונטיות המודעה, שיעור ההקלקה הצפוי ואיכות דף הנחיתה. חוק הברזל: ציון גבוה חוסך לכם כסף על כל קליק; ציון נמוך מאלץ אתכם לשלם ביוקר.",
  },
  "Ad Rank": {
    category: "ppc",
  ...
  "Smart Bidding": {
    ...
    body: "מנגנון אוטומטי שבו ה-AI של גוגל מנהל את הצעות המחיר (Bids) שלכם במכרזים על בסיס נתוני המרות אמיתיים. המערכת מחליטה בזמן אמת כמה לשלם על כל קליק כדי להביא לכם את מקסימום התוצאות בתקציב הנתון.",
  },
  "Performance Max": {
    category: "ppc",
    short: "Performance Max — קמפיין AI רב-ערוצי",
    body: "קמפיין הדגל האוטומטי של גוגל (PMax) שבו ה-AI מפזר את המודעות שלכם בכל ערוץ אפשרי במקביל: חיפוש, יוטיוב, ג'ימייל, מפות ורשת המדיה. כדי שהוא יעבוד, אתם חייבים להזין לו קריאייטיב מעולה ואותות קהל מדויקים.",
  },
  ...
  "Negative Keywords": {
    ...
    body: "מילות מפתח שליליות שמונעות מהמודעה שלכם לקפוץ בחיפושים לא רלוונטיים. למשל, אם אתם מוכרים שירותי פרימיום, תגדירו את המילה 'חינם' כביטוי שלילי כדי לא לשרוף תקציב על קליקים מבוזבזים.",
  },
  "Match Types": {
    category: "ppc",
  ...
  "Remarketing": {
    ...
    body: "קמפיינים ”שרודפים” אחרי גולשים שכבר ביקרו אצלכם באתר או השאירו פרטים, ומציגים להם מודעות מותאמות ברחבי הרשת. מדובר באחד הערוצים הכי רווחיים בדיגיטל, פשוט כי הרבה יותר קל למכור למישהו שכבר מכיר אתכם.",
  },
  "Landing Page": {
    category: "ppc",
    short: "דף נחיתה — הדף שאליו מגיע הגולש לאחר קליק",
    body: "עמוד עצמאי וממוקד מטרה שכל תפקידו הוא לגרום לגולש לבצע פעולה אחת ברורה (להשאיר פרטים, להתקשר או לקנות). הסוד שלו הוא התאמה מושלמת למודעה שממנה הגולש הגיע, בלי הסחות דעת ועם הנעה ברורה לפעולה.",
  },
  "Ad Extensions": {
    category: "ppc",
  ...
  "Bounce Rate": {
    ...
    body: "בגרסת GA4 המודרנית: אחוז הביקורים שבהם הגולשים לא גילו שום מעורבות (כלומר יצאו תוך פחות מ-10 שניות, בלי לעבור עמוד ובלי לבצע המרה). שיעור נמוך אומר שהקלעתם בול לצורך שלהם.",
  },
  "Conversion Rate": {
    category: "analytics",
  ...
  "CSR": {
    ...
    body: "טכנולוגיה שבה הדפדפן של הגולש הוא זה שמעבד ומייצר את עמוד האתר באמצעות JavaScript. הבעיה הגדולה איתה היא שלעיתים קרובות גוגל רואה דף ריק לחלוטין בביקור הראשון שלו – מה שהופך אותה לאסון עבור SEO.",
  },
  "Next.js": {
    category: "tech",
    short: "Next.js — פריימוורק React לאתרי Production",
    body: "פלתפורמת פיתוח מתקדמת (מבוססת React) שמייצרת אתרים סופר-מהירים ומאפשרת לטעון את כל התוכן ישירות מהשרת. זהו הפתרון המושלם כיום למי שרוצה אתר מודרני, מאובטח וחזק, עם נקודת זינוק מושלמת ל-SEO.",
  },
  "React": {
    category: "tech",
  ...
  "Above The Fold": {
    ...
    body: "הנדל״ן הדיגיטלי הראשון שהגולש רואה מיד כשהוא נכנס לאתר, עוד לפני שהוא בכלל חושב לגלול למטה. הכותרת, כפתור הפעולה והערך הייחודי שלכם חייבים לשבת שם בצורה בולטת.",
  },
  "Affiliate Marketing": {
    category: "marketing",
  ...
  "Crawl Budget": {
    ...
    body: "כמות הדפים המקסימלית שגוגל מוכן לסרוק אצלכם באתר בזמן נתון. אם האתר עמוס בעמודי זבל או פילטרים מיותרים, גוגל יבזבז עליהם את האנרגיה שלו ויפספס את העמודים החשובים באמת.",
  },
  "Indexing Bloat": {
    category: "seo",
  ...
  "Keyword Cannibalization": {
    ...
    body: "מצב שבו שני עמודים או יותר בתוך האתר שלכם רצים על אותה מילת מפתח. גוגל מתבלבל, לא יודע איזה דף להציג, ובסוף מוריד את שניהם בדירוג. הפתרון: מאחדים את התכנים לעמוד אחד חזק.",
  },
  "Local SEO": {
    category: "seo",
